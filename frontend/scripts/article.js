...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        'ar': {
            'error_loading_works': 'حدث خطأ في تحميل قائمة المقالات .',
            'error_loading_team': 'حدث خطأ في تحميل بيانات فريق العمل.',
            'no_works_archive': 'لا توجد مقالات لعرضها حالياً.',
            'no_team_members': 'لم يتم العثور على أعضاء فريق العمل.',
            'default_date': 'سنة الإنتاج',
            'loading_works': 'جاري تحميل المقالات...',
            'loading_team': 'جاري تحميل أسماء فريق العمل...',
            'archive_ticker_only': ' مقال ', 
        },
        'en': {
    "error_loading_works": "An error occurred while loading the articles list.",
    "error_loading_team": "An error occurred while loading the team data.",
    "no_works_archive": "There are no articles to display at the moment.",
    "no_team_members": "No team members were found.",
    "default_date": "Production Year",
    "loading_works": "Loading articles...",
    "loading_team": "Loading team members...",
    "archive_ticker_only": " article "
},
        'de':{
    "error_loading_works": "Beim Laden der Artikelliste ist ein Fehler aufgetreten.",
    "error_loading_team": "Beim Laden der Teamdaten ist ein Fehler aufgetreten.",
    "no_works_archive": "Derzeit sind keine Artikel verfügbar.",
    "no_team_members": "Keine Teammitglieder gefunden.",
    "default_date": "Produktionsjahr",
    "loading_works": "Artikel werden geladen...",
    "loading_team": "Teammitglieder werden geladen...",
    "archive_ticker_only": " Artikel "
}
